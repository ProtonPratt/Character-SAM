...
if __name__ == '__main__':
    ...
    parser.add_argument('--index_file', type=str, default='master_index_rand.json', help="Path to the dataset index JSON file.")
    parser.add_argument('--output_dir', type=str, default='inference_outputs_250', help="Directory to save the visual results.")
